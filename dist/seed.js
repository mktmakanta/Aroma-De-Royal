...
function importData() {
    return __awaiter(this, void 0, void 0, function () {
        var createdUsers, adminUser_1, sampleProducts, createdProducts, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    // Clear existing data
                    _a.sent();
                    return [4 /*yield*/, productsModel_1.default.deleteMany({})];
                case 3:
                    _a.sent();
                    return [4 /*yield*/, orderModel_1.default.deleteMany({})];
                case 4:
                    _a.sent();
                    return [4 /*yield*/, userModel_1.default.insertMany(user_1.default)];
                case 5:
                    ...
                    return [4 /*yield*/, productsModel_1.default.insertMany(sampleProducts)];
                case 6:
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    error_2 = _a.sent();
                    console.error("Error destroying data:", error_2);
                    process.exit(1);
                    return [3 /*break*/, 6];
